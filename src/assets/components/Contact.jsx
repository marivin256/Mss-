...
function Contact () {
    ...
    <section id="contact-details" className="section-p1 ">
        <div className="details">
            ...
            <div>
                <li>
                    <div><FaMap className="mr-2 text-yellow-500"/></div>
                    <p>Kampala,Kitebi</p>
                </li>
                <li>
                    <div><FaEnvelope className="mr-2 text-yellow-500"/></div>
                    <p>mss@gmail.com</p>
                </li>
                
                <li>
                    <div><FaClock className="mr-2 text-yellow-500"/></div>
                    <p>Monday to stutrday 8:00 am - 9:00 pm</p>
                </li>
            </div>
        </div>
        <div className="map">
